...
public:
	...
	void SendPackage(string t_sender, string t_receiver);//记录寄件时间，寄件人，收件人，签收状态
	void CollectPackage();
...
public:
	...
	void Adshowbynum(SOCKET&client_socket)const;//管理员通过单号进行查询历史快递
